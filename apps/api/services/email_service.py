...
class EmailService:
    ...
    def send_invite_email(self, to_email: str, inviter_name: str, org_name: str, invite_link: str) -> bool:
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p><strong>{inviter_name}</strong> has invited you to join <strong>{org_name}</strong> on Studio.</p>
            <p>
                <a href="{invite_link}" 
        ...
        """
        text_body = f"{inviter_name} has invited you to join {org_name} on Studio. Click here to accept: {invite_link}"
